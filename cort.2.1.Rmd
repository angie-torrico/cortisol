...
final_df$time_poly1<-poly(final_df$timess, degree = 1, coefs = NULL, raw = FALSE, simple = FALSE)

final_df$time_poly2<-poly(final_df$timess, degree = 2, coefs = NULL, raw = FALSE, simple = FALSE)
